...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_path', type=str, default="train/", help='Dataset path')
    parser.add_argument('--checkpoint_path', type=str, default="checkpoint/model/net-500_12.ckpt", help='Saved checkpoint file path')
    ...
    # define net
    net = resnet101(num_classes=config.class_num)
